...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f5f5;">
  ...
  `}async function p(a){try{let b=function(a){let{inviteeEmail:b,inviterName:c,organizationName:d,role:e,inviteToken:f}=a,g=process.env.NEXT_PUBLIC_APP_URL||"https://astralisone.com/api",h=`${g}/auth/accept-invite?token=${f}`;return`
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f5f5;">
  ...
  `}(a),c=function(a){let{inviteeEmail:b,inviterName:c,organizationName:d,role:e,inviteToken:f}=a,g=process.env.NEXT_PUBLIC_APP_URL||"https://astralisone.com/api",h=`${g}/auth/accept-invite?token=${f}`;return`
