...
The project is undergoing a significant "branded refactor" to implement the Astralis brand design system and expand its feature set as detailed in the `SETUP_GUIDE.md`.
