          ...
          <div className="flex items-center gap-2 pt-2 border-t border-slate-200 mt-2">
            {onAccept && (
              <Button
                ...
                disabled={isUpdating}
              >
                {isUpdating ? <Loader2 className=" w-5 h-5 mr-1 animate-spin" /> : <CheckCircle2 className=" w-5 h-5 mr-1" />}
                Accept
              </Button>
            )}
            {onDecline && (
              <Button
                ...
                disabled={isUpdating}
              >
                {isUpdating ? <Loader2 className=" w-5 h-5 mr-1 animate-spin" /> : <XCircle className=" w-5 h-5 mr-1" />}
                Decline
              </Button>
            )}
          </div>
