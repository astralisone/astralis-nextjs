...
/**
 * DropdownMenu component following Astralis brand specification
 *
 * Built on Radix UI DropdownMenu primitive for full accessibility support.
 *
 * Features:
...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <ChevronRight className="ml-auto h-[24px] w-[24px]" />
  </DropdownMenuPrimitive.SubTrigger>
));
