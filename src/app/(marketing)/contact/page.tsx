              ...
              <div className="bg-white border border-slate-200 rounded-xl shadow-xl p-6 md:p-10 lg:p-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                  <div className="space-y-2">
                    ...
                    {errors.name && <p id="name-error" className="text-sm text-red-600 flex items-center gap-1" role="alert"><AlertCircle className=" w-5 h-5" />{errors.name}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    {errors.email && <p id="email-error" className="text-sm text-red-600 flex items-center gap-1" role="alert"><AlertCircle className=" w-5 h-5" />{errors.email}</p>}
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    {errors.subject && <p id="subject-error" className="text-sm text-red-600 flex items-center gap-1" role="alert"><AlertCircle className=" w-5 h-5" />{errors.subject}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    {errors.message && <p id="message-error" className="text-sm text-red-600 flex items-center gap-1" role="alert"><AlertCircle className=" w-5 h-5" />{errors.message}</p>}
                  </div>
              ...
              <div className="bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-200 rounded-xl p-6 shadow-md">
                <div className="flex items-start gap-3">
                  <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-astralis-blue/10 flex-shrink-0">
                    <Clock className=" w-5 h-5 text-astralis-blue" />
                  </div>
                  <div>
