...
"[project]/projects/astralis-nextjs/src/app/api/revenue-audits/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    const targetUrl = `${apiBaseUrl}/api/revenue-audits`;
    try {
        // Get request body
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$projects$2f$astralis$2d$nextjs$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(data, {
            status: response.status
        });
    } catch (error) {
        console.error('Revenue audit booking proxy error:', {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$projects$2f$astralis$2d$nextjs$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Failed to create revenue audit booking',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4d16d677._.js.map